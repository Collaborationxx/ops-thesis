...
<br><br>
	<div id="page-wrapper" >
    	<div id="page-inner">
        	<div class="row">
            	<div class="col-md-12">
                    <h2><strong>Medical Supplies Order List</strong></h2>   
                 </div>
            </div>
                <hr />
                <div class="input-group custom-search-form">
                			<a href="delivey.php"><button class="btn btn-info" style="float:left; margin-left:15px;">PREVIEW OF ORDERS TO BE DELIVERED</button></a>
                            <input type="text" class="form-control" placeholder="Search..." style="width: 30%; margin-left: 345px;">
